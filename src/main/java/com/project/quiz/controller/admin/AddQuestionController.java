...
public class AddQuestionController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		req.setAttribute("quiz_id", quizId);
		req.getRequestDispatcher("../view/admin/view/addQuestion.jsp").forward(req, resp);
	}
	@Override
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		questionService.insert(new Question(quizId, content, optionA, optionB, optionC, optionD, correctOption,score));
